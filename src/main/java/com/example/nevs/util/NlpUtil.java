...
import com.example.nevs.util.hanlp.HanLpClassifier;
...
public class NlpUtil {
    ...
    public static void main(String[] args){
        ...
        System.out.println(textEmotion("垃圾玩意"));
        System.out.println(textEmotion("啥也不是"));
        System.out.println(textEmotion("坏玩意"));
        System.out.println(textEmotion("?"));
        System.out.println(textEmotion("非常赞"));
        System.out.println(textEmotion("你是sb吗"));
        System.out.println(textEmotion("别买这个东西,太烂了"));
        System.out.println(textEmotion("宝宝巴士"));
